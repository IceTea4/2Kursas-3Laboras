...
//        map.put(1, "one");
    ...
    @Test
    public void testGetNumberOfCollisions_EmptyMap() {
        HashMap<Integer, Car> map = new HashMap<>();

        assertEquals(0, map.getNumberOfCollisions());
    }

    @Test
    public void testGetNumberOfCollisions_SingleElement() {
        HashMap<Integer, Car> map = new HashMap<>();
        map.put(1, c1);
    ...
    @Test
    public void testGetNumberOfCollisionsMultiple_ElementsNoCollisions() {
        HashMap<Integer, Car> map = new HashMap<>();
        map.put(1, c1);
        map.put(2, c2);
        map.put(3, c3);
    ...
    @Test
    public void testGetNumberOfCollisionsWithCollisions() {
        HashMap<Integer, Car> map = new HashMap<>();
        map.put(3, c1);
        map.put(11, c2);
        map.put(20, c3);
        ...
        assertEquals(3, map.getNumberOfCollisions());
    }
}
